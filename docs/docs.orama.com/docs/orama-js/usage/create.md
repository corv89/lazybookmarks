---
Source: https://docs.orama.com/docs/orama-js/usage/create
...
If you want to learn more and see real-world examples, check out [this blog post](https://orama.com/blog/optimizing-orama-schema-optimization) we wrote about schema optimization.
