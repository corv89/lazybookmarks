---
Source: https://docs.orama.com/docs/orama-js/usage/insert
...
(Read more about database creation on the [create](/docs/orama-js/usage/create) page)
...
If the `id` field is not found, Orama will generate a random `id` for the document. To provide a custom ID for a document, see the [components](/usage/orama-js/internals/components) page.
