...
![Side panel drop-down menu](https://developers.google.com/static/docs/extensions/reference/api/sidePanel/images/example-side-panel.png)
...
![Pin icon in side panel UI.](https://developers.google.com/static/docs/extensions/reference/api/sidePanel/images/side-panel-pin.png)
