...
![A screenshot showing suggestions related to the keyword 'Chromium Search'](https://developers.google.com/static/docs/extensions/mv2/reference/omnibox/images/omnibox.png)
