...
# chrome.storage bookmark\_border Stay organized with collections Save and categorize content based on your preferences.
...
-   [Storage areas](#storage_areas)
    ...
    -   [Session](#session)
    -   [Sync](#sync)
-   [Methods and events](#methods_and_events)
    -   [get()](#get)
    ...
    -   [onChanged](#onchanged)
-   [Use cases](#use-cases)
    -   [Respond to storage updates](#respond_to_storage_updates)
...
[Example (Local)](#example-local)[Example (Sync)](#example-sync)[Example (Session)](#example-session)
