...
2.  Enable Developer Mode by clicking the toggle switch next to **Developer mode**.
    ...
    ![The Chrome Extensions page with Developer mode toggle highlighted](https://developers.google.com/static/docs/extensions/reference/api/userScripts/image/extensions-page-324e88e82e214.png)
...
![The Allow User Scripts toggle on the extension details page](https://developers.google.com/static/docs/extensions/reference/api/userScripts/image/allow-user-scripts-toggle.png)
