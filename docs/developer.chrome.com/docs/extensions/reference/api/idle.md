---
Source: https://developer.chrome.com/docs/extensions/reference/api/idle
Generated: 2026-01-05
Updated: 2026-01-05
---

# chrome.idle bookmark\_border Stay organized with collections Save and categorize content based on your preferences.
...
-   [Methods](#method)
    -   [getAutoLockDelay()](#method-getAutoLockDelay)
    -   [queryState()](#method-queryState)
    -   [setDetectionInterval()](#method-setDetectionInterval)
-   [Events](#event)
