...
![Life cycle of a web request from the perspective of the webrequest API](https://developers.google.com/static/docs/extensions/reference/api/webRequest/images/webrequestapi.png)
...
-   callback
    ...
    -   details
        ...
        -   securityInfo
            ...
            [SecurityInfo](#type-SecurityInfo) optional
