---
Source: https://developer.chrome.com/docs/ai/cache-models
...
![Adobe Photoshop on the web with the AI-powered object selection tool open, with three objects selected: two giraffes and a moon.](https://developers.google.com/static/docs/ai/cache-models/images/photoshop-in-browser.png)
...
![](https://developers.google.com/static/docs/ai/cache-models/images/cache-control.png)
...
**Note:** In general, the Chrome storage team recommends the [Cache API](#cache-api) for optimal performance, to ensure quick access to AI models, reducing load times, and improving responsiveness. This guide discusses the pros and cons of other possible storage mechanisms.
...
![](https://developers.google.com/static/docs/ai/cache-models/images/usage-graph.jpg)
...
**Tip**: Use the [Storage Buckets API](/docs/web-platform/storage-buckets) in supported browsers to mark your model as persisted:
...
This guide has explored various methods for effectively caching AI models in the browser, a  that's crucial for enhancing the user's experience with and the performance of your app. The Chrome storage team recommends the Cache API for optimal performance, to ensure quick access to AI models, reducing load times, and improving responsiveness.
