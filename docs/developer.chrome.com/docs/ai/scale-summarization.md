---
Source: https://developer.chrome.com/docs/ai/scale-summarization
...
[X](https://twitter.com/andreban) [GitHub](https://github.com/andreban) [Mastodon](https://mastodon.social/@andreban) [Bluesky](https://bsky.app/profile/bandarra.me) [Homepage](https://bandarra.me)
...
**Key Term:** The *[context window](https://developers.google.com/machine-learning/glossary#context-window)* is the amount of text a large language model (LLM) can process at one time, measured in [tokens](https://developers.google.com/machine-learning/glossary#token). A client-side model may process thousands of tokens at once, while a server-side model may process 1 million tokens.
...
![](https://developers.google.com/static/docs/ai/scale-summarization/images/summary-summaries.jpg)
...
**Tip:** This example was written before `inputQuota` was available. To best implement the summary of summaries strategy, [determine token availability](#determine_token_availability) before defining the maximum characters allowed in each chunk.
...
![](https://developers.google.com/static/docs/ai/scale-summarization/images/summary-squared.png)
