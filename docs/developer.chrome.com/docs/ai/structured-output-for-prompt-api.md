---
Source: https://developer.chrome.com/docs/ai/structured-output-for-prompt-api
...
Schema validator.](https://developers.google.com/static/docs/ai/structured-output-for-prompt-api/json-schema-validator.png)
